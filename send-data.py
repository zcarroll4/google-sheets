...
load_dotenv('C:/Users/zachc/repos/google-sheets/data.env')
...
creds = Credentials.from_service_account_file(
    'C:/Users/zachc/repos/google-sheets/analytics-dash.json',  # Replace with the path to your service account JSON file
